...
> **📖 Documentation map:** This guide covers product features and end-user workflows. For engineering depth — architecture decisions, security/threat model (STRIDE), audit-chain design, compliance boundaries, and the release runbook — see the [`docs/`](./docs/) directory and the [README](./README.md#engineering-highlights).
