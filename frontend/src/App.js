...
function AppRouter() {
  ...
  return (
    <Routes>
      ...
      <Route path="/transaction-detail/:intent_id" element={
        <ProtectedRoute>
          <AppLayout><TransactionDetail /></AppLayout>
        </ProtectedRoute>
      } />
      <Route path="/wallet-security" element={
        <ProtectedRoute>
          <AppLayout><WalletSecurity /></AppLayout>
        </ProtectedRoute>
      } />
