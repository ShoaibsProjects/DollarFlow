...
export default function WalletSecurity() {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="font-heading text-2xl font-bold text-foreground mb-2">Wallet Security Center</h1>
      ...
      <div className="space-y-4">
          ...
          >
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#0052FF]/10 flex items-center justify-center flex-shrink-0">
                <topic.icon className="w-5 h-5 text-[#0052FF]" />
              </div>
            ...
            {expanded[index] && (
              <div className="border-t border-border px-5 pb-5 text-sm text-muted-foreground space-y-3">
                <p>{topic.action}</p>
                {topic.details && (
        ...
        <div className="mt-8 rounded-2xl border border-border bg-card p-6">
          <h3 className="font-semibold text-foreground mb-4 flex items-center gap-2">
            <ExternalLink className="w-5 h-5 text-[#0052FF]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center gap-2 p-3 rounded-xl border border-border hover:bg-secondary transition-colors"
            >
            ...
            <button
              className="flex items-center gap-2 p-3 rounded-xl border border-border hover:bg-secondary transition-colors text-left"
            >
